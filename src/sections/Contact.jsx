...
const SERVICE_ID = "service_7rb065w";
const TEMPLATE_ID = "template_q94eapo";
const PUBLIC_KEY = "mwgAguz25eJ-ruA6v";
      ...
      >
        <div className="flex flex-col items-start w-full gap-5 mb-10">
          ...
          <p className="font-normal text-neutral-400">
            Whether you're building something new or improving existing,
            I'm here to help.
          </p>
        </div>
